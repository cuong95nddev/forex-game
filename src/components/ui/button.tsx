...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-[#10b981] text-white shadow-lg hover:bg-[#059669] hover:shadow-xl",
        destructive:
          "bg-[#ef4444] text-white shadow-lg hover:bg-[#dc2626] hover:shadow-xl",
        outline:
          "border-2 border-[#3d4f5c] bg-[#1e2a35] text-white shadow-sm hover:bg-[#2a3845] hover:border-[#10b981]",
        secondary:
          "bg-[#2a3845] text-white shadow-sm hover:bg-[#3d4f5c]",
        ghost: "text-white hover:bg-[#2a3845]",
